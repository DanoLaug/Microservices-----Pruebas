...
namespace Catalog.Service.EventHandlers.Commands
{
    ...
    {
        public IEnumerable<ProductInStockUpdateItem> Items { get; set; } = new
            List<ProductInStockUpdateItem>();
    }
    ...
    public class ProductInStockUpdateItem
    {
        ...
        // Dependencia adicional que se necesita crear para que funcione
